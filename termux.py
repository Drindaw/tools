...
| $$\  $$$ /$$__  $$  /$$__/  | $$      | $$  | $$
| $$ \  $$|  $$$$$$$ /$$$$$$$$| $$      |  $$$$$$/
|__/  \__/ \_______/|________/|__/       \______/ 
                                                  
                                                                                               
     \/           \/Tool by NAZRO          
\033[1;92m═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═
\x1b[1;36m{•} \x1b[1;93mAUTHOR     \033[1;31m➟    \x1b[1;92m: NAZRO.💓
\x1b[1;36m{•} \x1b[1;93mTOOL       \033[1;31m➟    \x1b[1;92m: COMPILE FILE
\x1b[1;36m{•} \x1b[1;93mFROM       \033[1;31m➟    \x1b[1;92m: KING MAK3R 💓
\033[1;92m═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═
"""
...
def main():
    ...
    print(Fore.MAGENTA + "[•] MULTI CONVO TOOL BY NAZRO")
    print(Fore.CYAN + "--------------WE ARE HERE----------------------")
    # Remake by Asmit
    tokens_file = input(Fore.YELLOW + "Enter the path to the tokens file: ").strip();line()
    target_id = input(Fore.YELLOW +  "Enter the target ID: ").strip();line()
    messages_file = input(Fore.YELLOW + "Enter the path to the messages file: ").strip();line()
    haters_name = input(Fore.YELLOW + "Enter the hater's name: ").strip();line()
